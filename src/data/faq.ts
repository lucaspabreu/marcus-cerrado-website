...
export const faq: FAQItem[] = [
  ...
  {
    id: "tempo-de-estudo",
    pergunta: "Quantas horas por dia preciso estudar?",
    resposta:
      "O Método CERRADO trabalha com rotinas honestas. A grade-base é construída pra três a cinco horas líquidas por dia, ajustável a quem trabalha. O que define a aprovação é a qualidade dessas horas, não a quantidade bruta.",
  },
  {
    id: "trocar-carreira",
