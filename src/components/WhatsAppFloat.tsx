...
export function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 sm:bottom-6 sm:right-6 z-50 inline-flex items-center justify-center rounded-full bg-[#25D366] p-4 text-white shadow-lg shadow-black/20 hover:bg-[#1ebe5a] hover:shadow-xl transition-all duration-200"
    >
      {/* WhatsApp glyph */}
      <svg
        viewBox="0 0 24 24"
