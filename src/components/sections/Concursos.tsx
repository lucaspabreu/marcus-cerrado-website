...
export function Concursos() {
  ...
  return (
    ...
    >
      {/* Dark map panel */}
      <div className="rounded-xl bg-[var(--ink)] overflow-hidden ring-1 ring-[var(--ink-soft)]">
        <div className="grid lg:grid-cols-12">
          {/* MAP — narrower column */}
          <div className="lg:col-span-5 p-6 sm:p-8 lg:border-r border-[#222]">
            ...
            {/* Constrain map width — smaller than before */}
            ...
            {/* Legend */}
            <div className="mt-6 pt-5 border-t border-[#222] grid grid-cols-2 gap-x-3 gap-y-2">
              {statusOrdem
                  ...
                  {items.map((concurso) => {
                    ...
                    return (
                      <li
                        ...
                        className={cn(
                          "group flex items-baseline gap-3 sm:gap-4 py-2 px-2 -mx-2 rounded-md cursor-pointer transition-all duration-150 border-b border-[#1d1d1d] last:border-b-0",
      ...
      <p className="mt-5 text-xs text-[var(--neutral)] leading-relaxed">
